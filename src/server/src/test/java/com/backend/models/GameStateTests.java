...
public class GameStateTests 
{
	...
	public void testGameState()
	{
		...
		GameState gameState2 = new GameState(gameState, new TargetHitEvent(SideEnum.BLUE, TargetEnum.LOW));
		validateInitialState(gameState2);
		
		GameState gameState3 = new GameState(gameState2, new TargetHitEvent(SideEnum.YELLOW, TargetEnum.MID));
		validateInitialState(gameState3);
		
		GameState gameState4 = new GameState(gameState3, new TargetHitEvent(SideEnum.BLUE, TargetEnum.HIGH));
		validateInitialState(gameState4);
		
		// Let's change one actuator
		GameState gameState5 = new GameState(gameState4, new ActuatorStateChangedEvent(SideEnum.BLUE, TargetEnum.LOW, ActuatorStateEnum.BLUE));
		...
		GameState gameState6 = new GameState(gameState5, new ActuatorStateChangedEvent(SideEnum.BLUE, TargetEnum.LOW, ActuatorStateEnum.YELLOW));
		...
		GameState gameState7 = new GameState(gameState6, new TargetHitEvent(SideEnum.BLUE, TargetEnum.LOW));
		Validate.isTrue(gameState7.blueScore == 0);
		Validate.isTrue(gameState7.yellowScore == 10);
		
		// And yellow score again!
		GameState gameState8 = new GameState(gameState7, new TargetHitEvent(SideEnum.BLUE, TargetEnum.LOW));
		Validate.isTrue(gameState8.blueScore == 0);
		Validate.isTrue(gameState8.yellowScore == 20);
		
		GameState gameState9 = new GameState(gameState8, new ActuatorStateChangedEvent(SideEnum.BLUE, TargetEnum.MID, ActuatorStateEnum.BLUE));
		Validate.isTrue(gameState9.actuatorsStates[SideEnum.BLUE.ordinal()][TargetEnum.MID.ordinal()] == ActuatorStateEnum.BLUE);
		
		GameState gameState10 = new GameState(gameState9, new ActuatorStateChangedEvent(SideEnum.BLUE, TargetEnum.HIGH, ActuatorStateEnum.BLUE));
		Validate.isTrue(gameState10.actuatorsStates[SideEnum.BLUE.ordinal()][TargetEnum.HIGH.ordinal()] == ActuatorStateEnum.BLUE);
		
		GameState gameState11 = new GameState(gameState10, new TargetHitEvent(SideEnum.BLUE, TargetEnum.HIGH));
		Validate.isTrue(gameState11.blueScore == 80);
		Validate.isTrue(gameState11.yellowScore == 20);
		
		GameState gameState12 = new GameState(gameState11, new TargetHitEvent(SideEnum.BLUE, TargetEnum.LOW));
		...
		GameState gameState13 = new GameState(gameState12, new TargetHitEvent(SideEnum.YELLOW, TargetEnum.HIGH));
		Validate.isTrue(gameState13.blueScore == 80);
		Validate.isTrue(gameState13.yellowScore == 30);
		
		GameState gameState14 = new GameState(gameState13, new ActuatorStateChangedEvent(SideEnum.YELLOW, TargetEnum.MID, ActuatorStateEnum.YELLOW));
		Validate.isTrue(gameState14.blueScore == 80);
		Validate.isTrue(gameState14.yellowScore == 30);
		
		GameState gameState15 = new GameState(gameState14, new TargetHitEvent(SideEnum.YELLOW, TargetEnum.HIGH));
		Validate.isTrue(gameState15.blueScore == 80);
		Validate.isTrue(gameState15.yellowScore == 30);
		
		GameState gameState16 = new GameState(gameState15, new TargetHitEvent(SideEnum.YELLOW, TargetEnum.MID));
		Validate.isTrue(gameState16.blueScore == 80);
		Validate.isTrue(gameState16.yellowScore == 50);
		
		GameState gameState17 = new GameState(gameState16, new ActuatorStateChangedEvent(SideEnum.BLUE, TargetEnum.LOW, ActuatorStateEnum.BLUE));
		Validate.isTrue(gameState17.actuatorsStates[SideEnum.BLUE.ordinal()][TargetEnum.LOW.ordinal()] == ActuatorStateEnum.BLUE);
		
		GameState gameState18 = new GameState(gameState17, new TargetHitEvent(SideEnum.BLUE, TargetEnum.HIGH));
		...
		GameState gameState19 = new GameState(gameState18, new PointModifierEvent(TeamEnum.BLUE, -200, new LocalizedString(Locale.ENGLISH, "Salwyn's house robot touch captor", "Le robot de salwyn's house a touché le capteur")));
	...
	public void testAreAllActuatorSameColor()
	{
		...
		gameState = new GameState(previousGameState, new ActuatorStateChangedEvent(SideEnum.BLUE, TargetEnum.LOW, ActuatorStateEnum.BLUE));
		Validate.isTrue(GameState.areAllActuatorSameColor(previousGameState.actuatorsStates) == false);

		previousGameState = gameState;
		gameState = new GameState(previousGameState, new ActuatorStateChangedEvent(SideEnum.BLUE, TargetEnum.MID, ActuatorStateEnum.BLUE));
		Validate.isTrue(GameState.areAllActuatorSameColor(previousGameState.actuatorsStates) == false);
		
		previousGameState = gameState;
		gameState = new GameState(previousGameState, new ActuatorStateChangedEvent(SideEnum.BLUE, TargetEnum.HIGH, ActuatorStateEnum.BLUE));
		Validate.isTrue(GameState.areAllActuatorSameColor(previousGameState.actuatorsStates) == false);
		
		previousGameState = gameState;
		gameState = new GameState(previousGameState, new ActuatorStateChangedEvent(SideEnum.YELLOW, TargetEnum.LOW, ActuatorStateEnum.BLUE));
		Validate.isTrue(GameState.areAllActuatorSameColor(previousGameState.actuatorsStates) == false);
		
		previousGameState = gameState;
		gameState = new GameState(previousGameState, new ActuatorStateChangedEvent(SideEnum.YELLOW, TargetEnum.MID, ActuatorStateEnum.BLUE));
		Validate.isTrue(GameState.areAllActuatorSameColor(previousGameState.actuatorsStates) == false);
		
		// Yippi all actuator are the same color!
		previousGameState = gameState;
		gameState = new GameState(previousGameState, new ActuatorStateChangedEvent(SideEnum.YELLOW, TargetEnum.HIGH, ActuatorStateEnum.BLUE));
		Validate.isTrue(GameState.areAllActuatorSameColor(previousGameState.actuatorsStates) == true);
		
		previousGameState = gameState;
		gameState = new GameState(previousGameState, new ActuatorStateChangedEvent(SideEnum.BLUE, TargetEnum.MID, ActuatorStateEnum.YELLOW));
		Validate.isTrue(GameState.areAllActuatorSameColor(previousGameState.actuatorsStates) == false);
	}
}
