...
public class Playoff23Teams implements IPlayoff
{
	public ArrayList<PlayoffGroup> GenerateNextRound(Tournament tournament, PlayoffRound previousRound, int groupNo, GameTypeEnum gameType, ArrayList<School> preliminaryRanking)
	{
		...
		case PLAYOFF_DEMI:
		{
			...
			ArrayList<School> schoolsPoolD = previousRound.playoffGroups.get(0).getSchoolsRanked(quarterResults);
			ArrayList<School> schoolsPoolE = previousRound.playoffGroups.get(1).getSchoolsRanked(quarterResults);
			ArrayList<School> schoolsPoolF = previousRound.playoffGroups.get(2).getSchoolsRanked(quarterResults);
		...
		case PLAYOFF_FINAL:
		{
			...
			ArrayList<School> schoolsPoolG = previousRound.playoffGroups.get(0).getSchoolsRanked(demiResults);
			ArrayList<School> schoolsPoolH = previousRound.playoffGroups.get(1).getSchoolsRanked(demiResults);
